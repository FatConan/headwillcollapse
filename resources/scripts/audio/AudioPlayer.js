...
export default class AudioPlayer extends BaseClass{
    ...
    addListeners(){
        ...
        this.eventHandler.addListenerOnEvent("audioPlayer:timeupdate", this.audioWrapper, changeTimelinePosition);
        this.eventHandler.addListenerOnEvent("audioPlayer:ended", this.audioWrapper, audioEnded);

        this.audio.addEventListener("ended", (e) => this.eventHandler.triggerWithTarget(this.audioWrapper, "audioPlayer:ended", {e: e, player: this, trigger: this.audio}));
        this.audio.addEventListener("timeupdate", (e) => this.eventHandler.triggerWithTarget(this.audioWrapper, "audioPlayer:timeupdate", {e: e, player: this, trigger: this.audio}));
    }
